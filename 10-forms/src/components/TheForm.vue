<template>
  <form @submit.prevent="submitForm">
    ...
    <div class="form-control">
      <!-- When we pass the v-model value to the RatingControl component, we can use it as a prop.
      The props that will use the v-model value must be named modelValue.
      And the function that will be called when the value changes must be named update:modelValue. -->
